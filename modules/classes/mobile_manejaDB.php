...
{	
    ...
    function make_connDB($bd_database)
    {
		$this->_usuario = BD_USER_GASCOMB;
        $this->_password = BD_PASSWORD_GASCOMB;
		$this->_servidor = BD_SERVER;
		$this->_base = $bd_database;
