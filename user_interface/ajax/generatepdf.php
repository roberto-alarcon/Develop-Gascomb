...
<bookmark title="Document" level="0" ></bookmark>
    ...
    <table cellspacing="0" style="width:90%;">
      <tr>
        ...
        <td style="width: 80%; text-align: center; padding:15px"><span class="title_emp">GRUPO AUTOMOTRIZ EN SERVICIOS DE COMBUSTIBLE <br/>S.A. DE C.V.</span><br/><br/>
...
AL RECIBIR EL 
    ...
    <br>
 <page_footer>
       	<span class="text_medium"><span class="text_medium">GRUPO AUTOMOTRIZ EN SERVICIOS DE COMBUSTIBLE S.A. DE C.V. &nbsp; &nbsp; CALLE 2a ORIENTE SUR  #750 COL. SAN ROQUE, TUXTLA GUTIERREZ CHIAPAS C.P. 29040
		</span></span><br/><br/>
</page_footer>
</page>
