...
include_once PATH_CLASSES_FOLDER."class.activities.php";
	...
	$type_activity = $type_activity["name"];
...
<bookmark title="Document" level="0" ></bookmark>
   ...
   <table style="width: 90%; " cellpadding="0" cellspacing="0">
            <tr>
                ...
                <td style="text-align: right; width: 25%; height: 25px;" >
					No. DE FOLIO: <?php echo $folio_data["folio_id"]; ?></td>
				<td style="text-align: right; width: 25%; height: 25px;">ORDEN DE SERVICIO: <?php echo $folio_data["order_number"]; ?></td>
            </tr>
        </table>
    <table border="1" cellpadding="3" cellspacing="0" style="width: 93%;">
      ...
      <tr>
        <td rowspan="2"><span style="text-align: left; width: 40%; ">DEPENDENCIA: <?php echo $dependency_name; ?></span></td>
      ...
      <tr>
        <td colspan="4"><?php echo $folio_data["failures"]; ?></td>
      </tr>
	  <tr style="background:#EDEDED">
		...
		if($activities){
			...
			foreach($activities as $value){
				if($value["description"] !== ""){
					echo "<tr>
						<td colspan='4' align='left'>&nbsp;&nbsp;$i.- ".$value["description"]."</td>
					  </tr>";
					$i++;
				}
			}
...
<table width="100%" class="gradienttable"  border="1" cellpadding="3" cellspacing="0" >
  <tr style="background: #DDD; height: 22px;">
    <td colspan="4" style="height: 22px;"><p>NOMBRE RESPONSABLE DE LA UNIDAD:<br> <?php echo $folio_data["vehicle_operator"]; ?></p></td>
    <td colspan="6" style="height: 22px;"><p>TELEFONO OPERADOR: <br> <?php echo $folio_data["operator_tel"]; ?></p></td>
    <td colspan="5" style="height: 22px;"><p>COMBUSTIBLE: <?php echo $vehicle["fuel"]; ?><br> NIVEL DE COMBUSTIBLE: <?php echo $Inventory["fuel_level"]."%"; ?></p></td>
  </tr>
  <tr style="background:#EDEDED">
  ...
  <tr>
    <td colspan="15" align="center"><?php if(isset($Inventory["observations"])&&  $Inventory["observations"]!== ""){ 
										echo utf8_encode($Inventory["observations"]); 
										//echo htmlentities($Inventory["observations"], ENT_QUOTES,'UTF-8');
									//utf8_encode($var);
									}  ?></td>
  </tr>
  <tr>
  ...
  <tr>
    <td colspan="15" align="center">ORDEN DE SERVICIO: <?php echo $folio_data["order_number"]; ?></td>
  </tr>
</table>
<page_footer>
       	<span class="text_medium"><span class="text_medium">GRUPO MECANICO EMPRESARIAL, S.A DE C.V &nbsp; &nbsp; 5 DE MAYO No.105 COL- FRANCISCO VILLA, C.P. 09720, MÉXICO, D.F. TELS.: 5693-2370, 5693-2276, 5693-4367
